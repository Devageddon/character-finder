 ...
 * limitations under the License.
 */
(0,r.KO)(i,o,"app")},4161:function(e,t,n){n.d(t,{Jt:function(){return Zs},C3:function(){return aa},VC:function(){return Ks},KR:function(){return Vs},TF:function(){return Gs},hZ:function(){return Ys},yo:function(){return Qs}});n(4114),n(7642),n(8004),n(3853),n(5876),n(2475),n(5024),n(1698);var r=n(3405),i=n(852),o=n(4046),s=n(1363);const a="@firebase/database",c="1.0.8";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ws{constructor(e,t,n,r){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=r}get key(){return yt(this._path)?null:pt(this._path)}get ref(){return new Bs(this._repo,this._path)}get _queryIdentifier(){const e=Dn(this._queryParams),t=L(e);return"{}"===t?"default":t}get _queryObject(){return Dn(this._queryParams)}isEqual(e){if(e=(0,o.Ku)(e),!(e instanceof Ws))return!1;const t=this._repo===e._repo,n=Ct(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return t&&n&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+_t(this._path)}}class Bs extends Ws{constructor(e,t){super(e,t,new An,!1)}get parent(){const e=mt(this._path);return null===e?null:new Bs(this._repo,e)}get root(){let e=this;while(null!==e.parent)e=e.parent;return e}}class Hs{constructor(e,t,n){this._node=e,this.ref=t,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new lt(e),n=zs(this.ref,e);return new Hs(this._node.getChild(t),n,an)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;const t=this._node;return!!t.forEachChild(this._index,((t,n)=>e(new Hs(n,zs(this.ref,t),an))))}hasChild(e){const t=new lt(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Vs(e,t){return e=(0,o.Ku)(e),e._checkNotDeleted("ref"),void 0!==t?zs(e._root,t):e._root}function zs(e,t){return e=(0,o.Ku)(e),null===ht(e._path)?Qo("child","path",t,!1):Yo("child","path",t,!1),new Bs(e._repo,vt(e._path,t))}function Ks(e,t){e=(0,o.Ku)(e),Zo("push",e._path),Vo("push",t,e._path,!0);const n=cs(e._repo),r=js(n),i=zs(e,r),s=zs(e,r);let a;return a=null!=t?Ys(s,t).then((()=>s)):Promise.resolve(s),i.then=a.then.bind(a),i.catch=a.then.bind(a,void 0),i}function Gs(e){return Zo("remove",e._path),Ys(e,null)}function Ys(e,t){e=(0,o.Ku)(e),Zo("set",e._path),Vo("set",t,e._path,!1);const n=new o.cY;return gs(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}function Qs(e,t){Go("update",t,e._path,!1);const n=new o.cY;return ms(e._repo,e._path,t,n.wrapCallback((()=>{}))),n.promise}function Zs(e){e=(0,o.Ku)(e);const t=new Us((()=>{})),n=new Xs(t);return _s(e._repo,e,n).then((t=>new Hs(t,new Bs(e._repo,e._path),e._queryParams.getIndex())))}class Xs{constructor(e){this.callbackContext=e}respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new $s("value",this,new Hs(e.snapshotNode,new Bs(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new qs(this,e,t):null}matches(e){return e instanceof Xs&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}}Ii(Bs),$i(Bs);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Js="FIREBASE_DATABASE_EMULATOR_HOST",ea={};let ta=!1;function na(e,t,n,r){e.repoInfo_=new ue(`${t}:${n}`,!1,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams,!0),r&&(e.authTokenProvider_=r)}function ra(e,t,n,r,i){let o=r||e.options.databaseURL;void 0===o&&(e.options.projectId||I("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),E("Using default host for project ",e.options.projectId),o=`${e.options.projectId}-default-rtdb.firebaseio.com`);let s,a,c=Ms(o,i),l=c.repoInfo;"undefined"!==typeof process&&(a={NODE_ENV:"production",BASE_URL:"/character-finder/"}[Js]),a?(s=!0,o=`http://${a}?ns=${l.namespace}`,c=Ms(o,i),l=c.repoInfo):s=!c.repoInfo.secure;const u=i&&s?new X(X.OWNER):new Z(e.name,e.options,t);Xo("Invalid Firebase Database URL",c),yt(c.path)||I("Database URL must point to the root of a Firebase Database (not including a child path).");const h=oa(l,e,u,new Q(e.name,n));return new sa(h,e)}function ia(e,t){const n=ea[t];n&&n[e.key]===e||I(`Database ${t}(${e.repoInfo_}) has already been deleted.`),ys(e),delete n[e.key]}function oa(e,t,n,r){let i=ea[t.name];i||(i={},ea[t.name]=i);let o=i[e.toURLString()];return o&&I("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),o=new ss(e,ta,n,r),i[e.toURLString()]=o,o}class sa{constructor(e,t){this._repoInternal=e,this.app=t,this["type"]="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(as(this._repoInternal,this.app.options.appId,this.app.options["databaseAuthVariableOverride"]),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Bs(this._repo,ut())),this._rootInternal}_delete(){return null!==this._rootInternal&&(ia(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&I("Cannot call "+e+" on a deleted database.")}}function aa(e=(0,r.Sx)(),t){const n=(0,r.j6)(e,"database").getImmediate({identifier:t});if(!n._instanceStarted){const e=(0,o.yU)("database");e&&ca(n,...e)}return n}function ca(e,t,n,r={}){e=(0,o.Ku)(e),e._checkNotDeleted("useEmulator"),e._instanceStarted&&I("Cannot call useEmulator() after instance has already been initialized.");const i=e._repoInternal;let s;if(i.repoInfo_.nodeAdmin)r.mockUserToken&&I('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),s=new X(X.OWNER);else if(r.mockUserToken){const t="string"===typeof r.mockUserToken?r.mockUserToken:(0,o.Fy)(r.mockUserToken,e.app.options.projectId);s=new X(t)}na(i,t,n,s)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ft.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Ft.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};la()},1387:function(e,t,n){n.d(t,{LA:function(){return ce},aE:function(){return rt}});n(4114),n(7642),n(8004),n(3853),n(5876),n(2475),n(5024),n(1698);var r=n(6768),i=n(144);
/*!
  * vue-router v4.4.5
...
//# sourceMappingURL=chunk-vendors.adb6cb05.js.map